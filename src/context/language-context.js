...
export function useLanguage(i18n) {
  const [language, setLanguage] = useState(loadLanguage(i18n));
  ...
  const languageSelect = <LanguageSelect i18n={i18n} language={language} changeLanguage={changeLanguage}/>

  return [language, changeLanguage, languageSelect];
}
